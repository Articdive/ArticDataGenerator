...
@NoGeneratorEntries
public final class InstrumentTagGenerator extends StandardTagGenerator {
    public InstrumentTagGenerator() {
        super(new File(new File(Initializer.DATA_FOLDER_1_19_3, "tags"), "instrument"));
    }
}
