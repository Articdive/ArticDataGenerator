...
public final class BiomeGenerator_1_18_2 extends DataGenerator_1_18<Biome> {
    private static final Logger LOGGER = LoggerFactory.getLogger(BiomeGenerator_1_18_2.class);
    ...
    public JsonObject generate() {
        ...
        for (ResourceLocation biomeRL : biomeRLs) {
            ...
            biome.addProperty("category", Biome.getBiomeCategory(Holder.direct(b)).name());
