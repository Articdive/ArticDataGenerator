...
public final class BiomeGenerator_1_18 extends DataGenerator_1_18<Biome> {
    private static final Logger LOGGER = LoggerFactory.getLogger(BiomeGenerator_1_18.class);
