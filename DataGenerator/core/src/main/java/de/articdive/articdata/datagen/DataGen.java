    ...
    public static void main(String[] args) {
        ...
        switch (args[0].toLowerCase(Locale.ROOT).replace('_', '.')) {
            case "1.18.2" -> {
                ...
                DataGenHolder.addGenerator(DataGenType.BIOMES, "BiomeGenerator_1_18_2");
                ...
                DataGenHolder.addGenerator(DataGenType.DIMENSION_TYPES, "DimensionTypeGenerator_1_18_2");
