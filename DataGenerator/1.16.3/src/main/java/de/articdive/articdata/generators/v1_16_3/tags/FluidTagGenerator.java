...
@NoGeneratorEntries
public final class FluidTagGenerator extends DataGenerator<Void> {
    ...
    public JsonObject generate() {
        ...
        if (listedFiles != null) {
            ...
            for (int i = 0; i < children.size(); i++) {
                ...
                JsonObject fluidTag;
                try {
                    fluidTag = FileOutputHandler.GSON.fromJson(new JsonReader(new FileReader(file)), JsonObject.class);
